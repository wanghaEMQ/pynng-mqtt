...
void nng_mqtt_msg_set_property_u8(nng_msg *, uint8_t, uint8_t);
void nng_mqtt_msg_set_property_u16(nng_msg *, uint8_t, uint16_t);
void nng_mqtt_msg_set_property_u32(nng_msg *, uint8_t, uint32_t, uint8_t);
void nng_mqtt_msg_set_property_varint(nng_msg *, uint8_t, uint32_t);
void nng_mqtt_msg_set_property_binary(nng_msg *, uint8_t, uint8_t*, uint32_t);
void nng_mqtt_msg_set_property_str(nng_msg *, uint8_t, char *, uint32_t);
void nng_mqtt_msg_set_property_str_pair(nng_msg *, uint8_t, char *, uint32_t, char *, uint32_t, uint8_t);
...
void *nng_mqtt_msg_get_publish_properties(nng_msg *);
